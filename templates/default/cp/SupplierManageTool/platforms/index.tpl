                        ...
                        <div class="table-responsive" >
                            <table class="table table-sm table-borderless">
                                ...
                                {foreach $platforms as $item}
                                    <tr>
                                        <td><a href="/cp/SupplierManageTool/platforms/desc/?edit={$item.id}">{$item.id}</a></td>
                                        <td><a style="color: white;text-overflow: ellipsis; "
                                               href="/cp/SupplierManageTool/platforms/desc/?edit={$item.id}">{$item.name}</a></td>
                                        <td>{$item.margin}</td>
                                        <td>

                                            <a class="btn btn-sm btn-outline-primary" href="/cp/SupplierManageTool/platforms/desc/?edit={$item.id}" >
