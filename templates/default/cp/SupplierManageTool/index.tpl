        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12" style="white-space: nowrap;">
                    <a class="btn btn-primary inline-items" style="width: 33.2%;" href="/cp/SupplierManageTool/item/add/"><i class="fas fa-plus"></i>&nbsp;Add item</a>
                    <a class="btn btn-primary inline-items" style="width: 33.2%;" href="/cp/SupplierManageTool/priceRule/"><i class="fas fa-money-bill-wave"></i>&nbsp;Add price rule</a>
                    <a class="btn btn-primary inline-items" style="width: 33.2%;" href="/cp/SupplierManageTool/category/"><i class="fas fa-ellipsis-v"></i>&nbsp;Add/Edit category</a><br>
                    ...
                    <div class="collapse multi-collapse" id="moresettings" style="margin-top: 4px;">
                        <div class="card card-body" >
                            <form action="/cp/SupplierManageTool/" class="text-left" style="margin-left: 10px;" method="POST">
                                {include file='cp/SupplierManageTool/category/tree.tpl'}
                            </form>
                        </div>
                    </div>
                    <form action="/cp/SupplierManageTool/" class="text-left" style="padding-top: 10px;" method="GET">
                        ...
                        <label>
                            <input type="radio" class="only" name="only" value="Full">
                        ...
                        <label>
                            <input type="radio" class="only" name="only" value="Partly">
                    ...
                    <div class="table-responsive" >
                        <table class="table table-sm table-borderless">
                            ...
                            {foreach $products as $item}
                                <tr>
                                    <td><a href="/cp/SupplierManageTool/view/?view={$item.id}">
                                    ...
                                    <td><a style="color: white;text-overflow: ellipsis; " href="/cp/SupplierManageTool/view/?view={$item.id}">{$item.tag}</a></td>
                                    ...
                                    <td class="formattedCell">
                                        <span class="d-inline-block text-truncate" style="max-width: 286px;">
                                            <a style="color: white;text-overflow: ellipsis; " title="{$item.name.et}" href="/cp/SupplierManageTool/view/?view={$item.id}">{$item.name.et}</a>
                                        </span>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-sm btn-outline-primary" href="/cp/SupplierManageTool/view/?view={$item.id}" >
                                            <i class="fas fa-link"></i>
                                            View
                                        </a>
                                        <a class="btn btn-sm btn-outline-primary" href="/cp/SupplierManageTool/item/edit/?edit={$item.id}" >
