...
<main class="d-flex flex-column">
    <div class="py-3 fullHeight">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <a class="btn btn-primary" style="width: 100%;" href="/cp/SupplierManageTool/category/add"><i class="fas fa-plus"></i>&nbsp;Add category</a>
                    ...
                    <div class="text-left" style="margin-left: 10px;">
                        {include file='cp/SupplierManageTool/category/linkModal.tpl'}
                        {function name=cat_tree margin=1}
                            {foreach $data as $key => $value}
                                {if is_null($value.child)}
                                    ...
                                    <a class="btn btn-link btn-cat" href="/cp/SupplierManageTool/category/edit/?edit={$value.id}" >
                                ...
                                {else}
                                    <label class='form-check-label label-cat'>{$value.id}</label>
                                    <label class='form-check-label text-white label-cat' data-toggle='collapse' data-target="#{$key}"
                                    ...
                                    {/if}
                                    <hr class="hr-cat">
                                    <div  class='collapse collapseDiv' id='{$key}' style="margin: 0 0 0 {$margin*20}px">
                                        {if !is_null($value.child)}
