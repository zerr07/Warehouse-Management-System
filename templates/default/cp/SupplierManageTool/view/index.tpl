                    ...
                    <div class="col-12" style="display: inline-flex;">
                        <div class="col-8" style="width: 79.9%;">
                            ...
                            <div style="margin-top: 15px;">
                                <a href="/cp/SupplierManageTool/item/edit/addQuantity.php?editSMT={$item.id}&ammount=plus1" class="btn btn-primary">+1</a>
                                <a href="/cp/SupplierManageTool/item/edit/addQuantity.php?editSMT={$item.id}&ammount=plus3" class="btn btn-primary">+3</a>
                                <a href="/cp/SupplierManageTool/item/edit/addQuantity.php?editSMT={$item.id}&ammount=plus5" class="btn btn-primary">+5</a>
                                <a href="/cp/SupplierManageTool/item/edit/addQuantity.php?editSMT={$item.id}&ammount=plus10" class="btn btn-primary">+10</a>
                                <a href="/cp/SupplierManageTool/item/edit/addQuantity.php?editSMT={$item.id}&ammount=minus1" class="btn btn-secondary">-1</a>
                            </div>
                        </div>
                        <div class="col-3">
                        ...
                        <table class="table table-borderless">
                            ...
                            <a href="/cp/SupplierManageTool/item/edit/?edit={$item.id}" style="float: left;" class="btn btn-primary"><i class="fas fa-edit"></i> Edit</a>
                            <a class="btn btn-primary" style="display: inline-block; float:right;" href="/cp/SupplierManageTool/"><i class="fas fa-undo-alt"></i> Back</a>
                </div>
            </div>
        </div>
    </div>
