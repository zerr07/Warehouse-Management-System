...
{else}
    ...
    <div id="carousel_live{$item.id}" class="row align-items-center carousel slide" data-ride="carousel" style="width: 300px;min-height:300px;height:300px;margin: auto;">
