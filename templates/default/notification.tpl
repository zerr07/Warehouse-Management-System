<div role="alert" id="customToast" aria-live="assertive" aria-atomic="true" class="toast customToast" data-autohide="false" style="max-width: 400px !important;">
    <div class="toast-header">
        ...
        <small id="publishedTime">18<sup>th</sup> of March 2021</small>
    ...
    <div class="toast-body">
        ...
        <img src="/templates/default/assets/bci9dk7hunn61.png" style="max-height: 300px; max-width: 350px; width: auto">
    </div>
</div>
<script>
    $(document).ready(function(){
        ...
        let current_value = '18032021T145254'
