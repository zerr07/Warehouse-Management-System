<div role="alert" id="customToast" aria-live="assertive" aria-atomic="true" class="toast" data-autohide="false" style="max-width: 400px !important;">
    <div class="toast-header">
        ...
        <small id="publishedTime">16<sup>th</sup> of December 2020</small>
    ...
    <div class="toast-body">
        ...
        <img src="/templates/default/assets/kEBejVmAges.jpg" style="max-height: 300px; max-width: 350px; width: auto">
    </div>
</div>
<script>
