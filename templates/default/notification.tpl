<div role="alert" id="customToast" aria-live="assertive" aria-atomic="true" class="toast" data-autohide="false" style="max-width: 400px !important;">
    <div class="toast-header">
        ...
        <small id="publishedTime">12<sup>th</sup> of January 2021</small>
    ...
    <div class="toast-body">
        ...
        <img src="/templates/default/assets/JPZwDEtaBT0.jpg" style="max-height: 300px; max-width: 350px; width: auto">
    </div>
</div>
<script>
